...
% -------
% ------- TOP PANEL ---------------
h1=plot([1:5],num_wake_episodesRW,'k',[1:5],num_wake_episodesRW,'ko','MarkerSize',12);
...
h3=plot([1:5],num_wake_episodesAW,'k',[1:5],num_wake_episodesAW,'ko','MarkerSize',12);
...
% ------ MIDDLE PANEL -----------------
figure
h1=plot([1:5],mean_SWS_lengthRW,'k',[1:5],mean_SWS_lengthRW,'ko','MarkerSize',12);
set(h1(2),'MarkerEdgeColor','none','MarkerFaceColor','k')
hold on 
h2=errorbar([1:5],mean_SWS_lengthRW,std_SWS_episode_duration_vs_timeRW/length(mean_SWS_lengthRW),'k');

h3=plot([1:5],mean_SWS_lengthAW,'k',[1:5],mean_SWS_lengthAW,'ko','MarkerSize',12);
...
% ------- BOTTOM PANEL ----------------
figure
h1=plot([1:5],REMS_episode_duration_RW_averages,'k',[1:5],REMS_episode_duration_RW_averages,'ko','MarkerSize',12);
set(h1(2),'MarkerEdgeColor','none','MarkerFaceColor','k')
hold on 
h2=errorbar([1:5],REMS_episode_duration_RW_averages,REMS_episode_duration_RW_Std,'k');

h3=plot([1:5],REMS_episode_duration_AW_averages,'k',[1:5],REMS_episode_duration_AW_averages,'ko','MarkerSize',12);
