function dydt = circadian_oscillator(t,y,It,I,sleep_statet,sleep_state)
...
I = interp1(It,I,t);   % interpolate data (It,I) at times t
sleep_state = interp1(sleep_statet,sleep_state,t);  
...
% % --- parameters from new paper ---
p 		= 0.5;
I0 		= 9500;
I1 		= 100;
alpha0 	= 0.1;%0.1*60; 		% 1/sec
beta 	= 0.007; %0.007*60;
rho 	= 0.032;
Omega 	= 7.2722e-5;  	% 1/sec
k 		= 0.51;
q 		= 0.33;
gamma 	= 0.13;
G 		= 2220; %37/60/60;
...
dydt(2) = Omega*( q*B(alpha,y(3),y(1),y(2))*y(2)-y(1)*((delta)^2+k*B(alpha,y(3),y(1),y(2))) );
...
% 		y(1)*((delta)^2+k*(G*alpha*(1-y(3))*(1-epsilon*y(1))*(1-epsilon*y(2))) ) );
% dydt(1) = Omega*( y(2)+gamma*((1/3)*y(1)-(4/3)*(y(1))^3-(256/105)*(y(1))^7) +(G*alpha*(1-y(3))*(1-epsilon*y(1))*(1-epsilon*y(2))) + rho*((1/3)-sleep_state)*(1-tanh(10*y(1))) );
